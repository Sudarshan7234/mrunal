    ...
    <div>
      <div className="mt-20 flex flex-col items-start space-y-5 md:mt-32 md:space-y-7 md:px-5 lg:mt-32">
        ...
        <p className="text-xl">
          ...
          ,{' '}
          <a
            href="https://www.linkedin.com/in/mrunal-chodankarr-08875332a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            target="_blank"
            rel="noopener noreferrer"
            className="underline"
          >
